	 ...
	 while($row = oci_fetch_array($a, OCI_BOTH+OCI_RETURN_NULLS))  //parse or execute for update, insert
      	  {
				...
				<tr align = "left">
					...
					<td style="font-size:16px;">
						<label>Salary : </label><?php echo $row[3];?>
					</td>
						
					
					<td style="font-size:16px;">
						<label>Phone : </label><?php echo $row[4];?>
					</td>	
					<td style="font-size:16px;">
						<label>Position : </label><?php echo $row[5];?>
					</td>					
...
<table>
  <tr align = "center">
				<td><br><br><a href="j.html">Back</a></td>
			</tr>
			</table>
